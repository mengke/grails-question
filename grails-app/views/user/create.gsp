...
<body>
<a href="#create-user" class="sr-only" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-user" role="main">
    ...
    <g:form class="form-horizontal" role="form" url="[resource: userInstance, action: 'save']">
